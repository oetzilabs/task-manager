...
import { ToggleButton, Tooltip } from "@kobalte/core";
...
export function TipTap(
  ...
  const editor = createTiptapEditor(() => ({
    ...
    editorProps: {
      attributes: {
        class: "focus:outline-none prose max-w-full",
      },
    },
  ...
  return (
    <>
      <Show when={typeof props.disabled !== "undefined" && !props.disabled}>
        <div class="w-full h-full flex flex-col">
          <input type="hidden" name={props.name} value={JSON.stringify(editorContent()) ?? ""} />
          <Show when={editor()} keyed>
            {(instance) => <ToolbarContents editor={instance} />}
          </Show>
          <div class="h-auto bg-white overflow-y-scroll rounded-sm" ref={setContainer} />
        </div>
      </Show>
      <Show when={typeof props.disabled !== "undefined" && props.disabled}>
        <div class="w-full h-full flex flex-col">
